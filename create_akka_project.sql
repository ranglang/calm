CREATE TABLE IF NOT EXISTS event_journal1(
                                            slice INT NOT NULL,
...
CREATE INDEX IF NOT EXISTS event_journal_slice_idx ON event_journal1(slice, entity_type, db_timestamp, seq_nr);

CREATE TABLE IF NOT EXISTS snapshot1(
                                       slice INT NOT NULL,
                                       entity_type VARCHAR(255) NOT NULL,
    persistence_id VARCHAR(255) NOT NULL,
    seq_nr BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS durable_state1 (
                                             slice INT NOT NULL,
                                             entity_type VARCHAR(255) NOT NULL,
    persistence_id VARCHAR(255) NOT NULL,
...
CREATE INDEX IF NOT EXISTS durable_state_slice_idx ON durable_state1(slice, entity_type, db_timestamp, revision);
