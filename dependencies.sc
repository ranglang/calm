...
object lqiong {
  ...
  val aliyunLog1 = Agg(
    ivy"com.aliyun.openservices:aliyun-log-logback-appender:0.1.15"
  )
  val logOthers = Agg(
    ivy"net.logstash.logback:logstash-logback-encoder:5.2" excludeOrg "com.fasterxml.jackson.core",
    ivy"org.codehaus.janino:janino:3.0.16",
    ivy"org.codehaus.janino:commons-compiler:3.0.16",
  ...
  val jodaTime = Agg(
    ivy"joda-time:joda-time:2.10.14",
    ivy"org.joda:joda-convert:2.2.2"
  )
  ...
  val tapir = Agg(
    ...
    ivy"com.softwaremill.sttp.tapir::tapir-openapi-docs:$tapirVersion" excludeOrg "com.typesafe.akka",
    ivy"com.softwaremill.sttp.apispec::openapi-circe-yaml:0.2.1" excludeOrg "com.typesafe.akka",
...
//    ivy"com.github.cb372::scalacache-cats-effect:$scalacacheVersion"
  ...
  val cluster = Agg(
    ...
    ("com.typesafe.akka", "akka-cluster-tools"), ("com.typesafe.akka", "akka-stream"), (
      "com.typesafe.akka",
...
//    ivy"com.typesafe.akka::akka-http-xml:$akkaHttpVersion",
  ...
  val circleJava = Agg(
    ivy"io.circe:circe-core_2.13:$circeVersion",
    ivy"io.circe:circe-shapes_2.13:$circeVersion",
    ivy"io.circe:circe-generic_2.13:$circeVersion",
    ivy"io.circe:circe-parser_2.13:$circeVersion",
    ivy"io.circe:circe-generic-extras_2.13:$circeVersion"
  )
  ...
  val scassandra = Agg(
    ivy"com.evolutiongaming::scassandra:$scassandraVersion" exclude ((
...
//      exclude (("com.fasterxml.jackson.core", "jackson-databind"))
  ...
  val jep = Agg(
    ...
    ivy"com.datastax.oss:java-driver-core:4.6.1" exclude ((
      "com.fasterxml.jackson.core",
      "jackson-databind"
    ))
  )
  ...
  val json = Agg(
    ...
    ivy"de.heikoseeberger::akka-http-circe:1.36.0" excludeOrg "com.typesafe.akka"
  ).++(circle)
  ...
  val modelVersion = "0.0.42"
  val boatVersion = "0.0.38"

  val modelJar = Agg(
    ivy"tech.shangche::model:${modelVersion}"
  )
  ...
  val modelDeps = Agg(
    ivy"tech.shangche::notion:0.0.33",
    ivy"tech.shangche::cronish:0.0.32"
  ).++(modelJar)

  val quill = Agg(
    ivy"org.tpolecat::skunk-core:0.2.2",
    ivy"org.tpolecat::skunk-circe:0.2.2",
  ...
  val nameof = Agg(
    ivy"com.github.dwickern::scala-nameof:4.0.0"
  )
  ...
  val plotly = Agg(
    ivy"org.plotly-scala::plotly-core:0.8.4",
    ivy"org.plotly-scala::plotly-render:0.8.4"
  )
