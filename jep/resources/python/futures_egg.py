...
def futures_egg_price_yearly() -> pd.DataFrame:
    ...
    print("value_2017_list")
    print(value_2017_list)

    print("value_2017_list")
    print(value_2017_list)

    print("value_2018_list")
    print(value_2018_list)
    print("value_2019_list")
    print(value_2019_list)
    print("value_2020_list")
    print(value_2020_list)
    print("value_2021_list")
    print(value_2021_list)
    print("value_2022_list")
    print(value_2022_list)
...
def futures_egg_price() -> pd.DataFrame:
    ...
    js_text_processed = re.findall(r"(\[.*?])", js_text_processed)
    print("js_text_processed1 %s", js_text_processed[1])
    print("js_text_processed2 %s", js_text_processed[2])
    print("js_text_processed3 %s", js_text_processed[3])
    print("js_text_processed4 %s", js_text_processed[4])
    print("js_text_processed5 %s", js_text_processed[5])

    print("xxxxx")
    print("js_text_processed %s", js_text_processed[3])
    print("js_text_processed4 %s", js_text_processed[4])
    print("xxxxx1")
    date_list = eval(js_text_processed[2])
    ...
    print(len(date_list))
    value_2015_list = eval(re.findall(r"data: (\[.*?])", js_text_processed[4])[0])
