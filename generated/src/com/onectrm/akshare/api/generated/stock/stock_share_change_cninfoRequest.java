    ...
    */
    public class stock_share_change_cninfoRequest extends AkShareRequestAndResponse {
    public stock_share_change_cninfoRequest(){
    setInterfaceName("stock_share_change_cninfo");
    }
    ...
    public static stock_share_change_cninfoRequest of(
    ...
    <String
    , String>... others){
    stock_share_change_cninfoRequest t = new stock_share_change_cninfoRequest();
