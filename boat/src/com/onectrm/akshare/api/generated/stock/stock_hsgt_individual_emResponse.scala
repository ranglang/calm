...
import com.onectrm.akshare.api.generated.stock.stock_hsgt_individual_emResponse
...
/** 分类1: stock 接口: stock_hsgt_individual_em 目标地址:
  * http://data.eastmoney.com/hsgtcg/StockHdStatistics/002008.html(示例) 描述:
  * 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票 限量: 单次获取指定 stock 的近期数据
  */
case class Respstock_hsgt_individual_emResponse(
...
case class stock_hsgt_individual_emResponse(
  `p_chi2gu3ri4qi1`: String,
  `p_dang1ri4shou1pan2jia4`: Double,
  `p_dang1ri4zhang3die1fu2`: Double,
  `p_chi2gu3shu4liang4`: Integer,
...
trait Json_stock_hsgt_individual_emResponse {

  implicit val a_stock_hsgt_individual_emResponse = new Decoder[stock_hsgt_individual_emResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_hsgt_individual_emResponse] =
      for {
        ...
        stock_hsgt_individual_emResponse(
          p_chi2gu3ri4qi1,
...
object JsonItem_stock_hsgt_individual_emResponse extends Json_stock_hsgt_individual_emResponse
