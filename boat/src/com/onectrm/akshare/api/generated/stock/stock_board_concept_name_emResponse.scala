...
import com.onectrm.akshare.api.generated.stock.stock_board_concept_name_emResponse
...
/** 分类1: stock 接口: stock_board_concept_name_em 目标地址:
  * http://quote.eastmoney.com/center/boardlist.html#concept_board 描述: 东方财富-沪深板块-概念板块 限量:
  * 单次返回当前时刻所有概念板块数据
  */
case class Respstock_board_concept_name_emResponse(
  `p_pai2ming2`: Integer,
...
case class stock_board_concept_name_emResponse(
  `p_pai2ming2`: Integer,
  `p_ban3kuai4ming2cheng1`: String,
  `p_ban3kuai4dai4ma3`: String,
  `p_zui4xin1jia4`: Double,
...
trait Json_stock_board_concept_name_emResponse {

  implicit val a_stock_board_concept_name_emResponse =
    new Decoder[stock_board_concept_name_emResponse] {
      final def apply(c: HCursor): Decoder.Result[stock_board_concept_name_emResponse] =
        for {
          ...
          stock_board_concept_name_emResponse(
            p_pai2ming2,
...
object JsonItem_stock_board_concept_name_emResponse extends Json_stock_board_concept_name_emResponse
