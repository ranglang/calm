...
import com.onectrm.akshare.api.generated.stock.stock_gdfx_free_holding_detail_emResponse
...
/** 分类1: stock 接口: stock_gdfx_free_holding_detail_em 目标地址:
  * https://data.eastmoney.com/gdfx/HoldingAnalyse.html 描述: 东方财富网-数据中心-股东分析-股东持股明细-十大流通股东 限量: 单次返回指定
  * date 的所有数据
  */
case class Respstock_gdfx_free_holding_detail_emResponse(
  `p_xu4hao4`: Integer,
...
case class stock_gdfx_free_holding_detail_emResponse(
  `p_xu4hao4`: Integer,
  `p_gu3dong1ming2cheng1`: String,
  `p_gu3dong1lei4xing2`: String,
  `p_gu3piao4dai4ma3`: String,
...
trait Json_stock_gdfx_free_holding_detail_emResponse {

  implicit val a_stock_gdfx_free_holding_detail_emResponse =
    new Decoder[stock_gdfx_free_holding_detail_emResponse] {
      final def apply(c: HCursor): Decoder.Result[stock_gdfx_free_holding_detail_emResponse] =
        for {
          ...
          stock_gdfx_free_holding_detail_emResponse(
            p_xu4hao4,
...
object JsonItem_stock_gdfx_free_holding_detail_emResponse
    extends Json_stock_gdfx_free_holding_detail_emResponse
