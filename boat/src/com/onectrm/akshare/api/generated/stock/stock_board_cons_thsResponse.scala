...
import com.onectrm.akshare.api.generated.stock.stock_board_cons_thsResponse
...
/** 分类1: stock 接口: stock_board_cons_ths 目标地址: http://q.10jqka.com.cn/thshy/detail/code/881121/ 描述:
  * 同花顺-板块-行业板块-成份股数据 限量: 单次返回当前时刻所有成份股, 调用 **ak.stock_board_industry_info_ths()** 返回该板块信息
  */
case class Respstock_board_cons_thsResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
...
case class stock_board_cons_thsResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
  `p_ming2cheng1`: String,
  `p_xian4jia4`: Double,
...
trait Json_stock_board_cons_thsResponse {

  implicit val a_stock_board_cons_thsResponse = new Decoder[stock_board_cons_thsResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_board_cons_thsResponse] =
      for {
...
object JsonItem_stock_board_cons_thsResponse extends Json_stock_board_cons_thsResponse
