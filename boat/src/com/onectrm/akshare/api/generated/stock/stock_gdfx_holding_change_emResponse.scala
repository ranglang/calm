...
import com.onectrm.akshare.api.generated.stock.stock_gdfx_holding_change_emResponse
...
/** 分类1: stock 接口: stock_gdfx_holding_change_em 目标地址:
  * https://data.eastmoney.com/gdfx/HoldingAnalyse.html 描述: 东方财富网-数据中心-股东分析-股东持股变动统计-十大股东 限量: 单次返回指定
  * date 的所有数据
  */
case class Respstock_gdfx_holding_change_emResponse(
  `p_xu4hao4`: Integer,
...
case class stock_gdfx_holding_change_emResponse(
  `p_xu4hao4`: Integer,
  `p_gu3dong1ming2cheng1`: String,
  `p_gu3dong1lei4xing2`: String,
  `p_qi1mo4chi2gu3zhi3shu4tong3ji4zong3chi2you3`: Double,
...
trait Json_stock_gdfx_holding_change_emResponse {

  implicit val a_stock_gdfx_holding_change_emResponse =
    new Decoder[stock_gdfx_holding_change_emResponse] {
      final def apply(c: HCursor): Decoder.Result[stock_gdfx_holding_change_emResponse] =
        for {
          ...
          stock_gdfx_holding_change_emResponse(
            p_xu4hao4,
...
object JsonItem_stock_gdfx_holding_change_emResponse
    extends Json_stock_gdfx_holding_change_emResponse
