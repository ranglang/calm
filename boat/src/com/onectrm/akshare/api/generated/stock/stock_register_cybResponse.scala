...
import com.onectrm.akshare.api.generated.stock.stock_register_cybResponse
...
/** 分类1: stock 接口: stock_register_cyb 目标地址: http://data.eastmoney.com/xg/cyb/ 描述:
  * 获取东方财富网-数据中心-新股数据-注册制审核-创业板 限量: 单次返回所有历史数据
  */
case class Respstock_register_cybResponse(
  `p_xu4hao4`: Long,
...
case class stock_register_cybResponse(
  `p_xu4hao4`: Long,
  `p_fa1xing2ren2quan2cheng1`: String,
  `p_shen3he2zhuang4tai4`: String,
  `p_zhu4ce4di4`: String,
...
trait Json_stock_register_cybResponse {

  implicit val a_stock_register_cybResponse = new Decoder[stock_register_cybResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_register_cybResponse] =
      for {
...
object JsonItem_stock_register_cybResponse extends Json_stock_register_cybResponse
