...
import com.onectrm.akshare.api.generated.stock.stock_zh_a_st_emResponse
...
/** 分类1: stock 接口: stock_zh_a_st_em 目标地址: http://quote.eastmoney.com/center/gridlist.html#st_board
  * 描述: 东方财富网-行情中心-沪深个股-风险警示板 限量: 单次返回当前交易日风险警示板的所有股票的行情数据
  */
case class Respstock_zh_a_st_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
...
case class stock_zh_a_st_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
  `p_ming2cheng1`: String,
  `p_zui4xin1jia4`: Double,
...
trait Json_stock_zh_a_st_emResponse {

  implicit val a_stock_zh_a_st_emResponse = new Decoder[stock_zh_a_st_emResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_zh_a_st_emResponse] =
      for {
...
object JsonItem_stock_zh_a_st_emResponse extends Json_stock_zh_a_st_emResponse
