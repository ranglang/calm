...
import com.onectrm.akshare.api.generated.stock.stock_rank_cxsl_thsResponse
...
/** 分类1: stock 接口: stock_rank_cxsl_ths 目标地址: http://data.10jqka.com.cn/rank/cxsl/ 描述:
  * 同花顺-数据中心-技术选股-持续缩量 限量: 单次返回所有数据
  */
case class Respstock_rank_cxsl_thsResponse(
  `p_xu4hao4`: Integer,
  ...
  `p_suo1liang4tian1shu4`: Integer,
  `p_jie1duan4zhang3die1fu2`: Double,
  `p_suo3shu3xing2ye4`: String
)

case class stock_rank_cxsl_thsResponse(
  `p_xu4hao4`: Integer,
  `p_gu3piao4dai4ma3`: String,
  `p_gu3piao4jian3cheng1`: String,
  `p_zhang3die1fu2`: Double,
...
trait Json_stock_rank_cxsl_thsResponse {

  implicit val a_stock_rank_cxsl_thsResponse = new Decoder[stock_rank_cxsl_thsResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_rank_cxsl_thsResponse] =
      for {
        ...
        p_suo1liang4tian1shu4 <- c.downField("缩量天数").as[Integer]
...
object JsonItem_stock_rank_cxsl_thsResponse extends Json_stock_rank_cxsl_thsResponse
