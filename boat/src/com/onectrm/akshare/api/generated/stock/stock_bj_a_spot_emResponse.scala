...
import com.onectrm.akshare.api.generated.stock.stock_bj_a_spot_emResponse
...
/** 分类1: stock 接口: stock_bj_a_spot_em 目标地址:
  * http://quote.eastmoney.com/center/gridlist.html#bj_a_board 描述: 东方财富网-京 A 股-实时行情数据 限量: 单次返回所有京 A
  * 股上市公司的实时行情数据
  */
case class Respstock_bj_a_spot_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
...
case class stock_bj_a_spot_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
  `p_ming2cheng1`: String,
  `p_zui4xin1jia4`: Double,
...
trait Json_stock_bj_a_spot_emResponse {

  implicit val a_stock_bj_a_spot_emResponse = new Decoder[stock_bj_a_spot_emResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_bj_a_spot_emResponse] =
      for {
...
object JsonItem_stock_bj_a_spot_emResponse extends Json_stock_bj_a_spot_emResponse
