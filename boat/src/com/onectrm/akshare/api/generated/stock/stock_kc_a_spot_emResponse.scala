...
import com.onectrm.akshare.api.generated.stock.stock_kc_a_spot_emResponse
...
/** 分类1: stock 接口: stock_kc_a_spot_em 目标地址:
  * http://quote.eastmoney.com/center/gridlist.html#hs_a_board 描述: 东方财富网-科创板-实时行情 限量:
  * 单次返回所有科创板的实时行情数据
  */
case class Respstock_kc_a_spot_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
...
case class stock_kc_a_spot_emResponse(
  `p_xu4hao4`: Integer,
  `p_dai4ma3`: String,
  `p_ming2cheng1`: String,
  `p_zui4xin1jia4`: Double,
...
trait Json_stock_kc_a_spot_emResponse {

  implicit val a_stock_kc_a_spot_emResponse = new Decoder[stock_kc_a_spot_emResponse] {
    final def apply(c: HCursor): Decoder.Result[stock_kc_a_spot_emResponse] =
      for {
...
object JsonItem_stock_kc_a_spot_emResponse extends Json_stock_kc_a_spot_emResponse
