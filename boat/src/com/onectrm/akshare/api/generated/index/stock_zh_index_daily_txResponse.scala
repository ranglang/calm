...
import com.onectrm.akshare.api.generated.index.stock_zh_index_daily_txResponse
...
/** 分类1: index 接口: stock_zh_index_daily_tx 目标地址: http://gu.qq.com/sh000919/zs 描述: 股票指数(或者股票)历史行情数据
