...
import com.onectrm.akshare.api.generated.index.stock_zh_index_spotResponse
...
/** 分类1: index 接口: stock_zh_index_spot 目标地址: http://vip.stock.finance.sina.com.cn/mkt/#hs_s 描述:
  * 新浪财经-中国股票指数数据 限量: 单次返回所有指数的实时行情数据
  */
