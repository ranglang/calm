...
import com.onectrm.akshare.api.generated.fund_private.amac_manager_infoResponse
...
/** 分类1: fund_private 接口: amac_manager_info 目标地址:
  * http://gs.amac.org.cn/amac-infodisc/res/pof/manager/index.html 描述:
  * 中国证券投资基金业协会-信息公示-私募基金管理人公示-私募基金管理人综合查询 限量: 单次返回当前时刻所有历史数据
  */
case class Respamac_manager_infoResponse(
...
case class amac_manager_infoResponse(
  `p_si1mu4ji1jin1guan3li3ren2ming2cheng1`: String,
  `p_fa3ding4dai4biao3ren2zhi2xing2shi4wu4he2huo3ren2wei3pai4dai4biao3xing4ming2`: Double,
  `p_ji1gou4lei4xing2`: Double,
  `p_zhu4ce4di4`: Double,
...
trait Json_amac_manager_infoResponse {

  implicit val a_amac_manager_infoResponse = new Decoder[amac_manager_infoResponse] {
    final def apply(c: HCursor): Decoder.Result[amac_manager_infoResponse] =
      for {
...
object JsonItem_amac_manager_infoResponse extends Json_amac_manager_infoResponse
