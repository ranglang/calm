...
import com.onectrm.akshare.api.generated.fund_public.fund_rating_jaResponse
...
/** 分类1: fund_public 接口: fund_rating_ja 目标地址: http://fund.eastmoney.com/data/fundrating_4.html 描述:
  * 获取天天基金网-基金评级-济安金信评级 限量: 单次返回指定交易日的所有基金评级数据
  */
case class Respfund_rating_jaResponse(
  `p_dai4ma3`: String,
...
case class fund_rating_jaResponse(
  `p_dai4ma3`: String,
  `p_jian3cheng1`: String,
  `p_ji1jin1jing1li3`: String,
  `p_ji1jin1gong1si1`: String,
...
trait Json_fund_rating_jaResponse {

  implicit val a_fund_rating_jaResponse = new Decoder[fund_rating_jaResponse] {
    final def apply(c: HCursor): Decoder.Result[fund_rating_jaResponse] =
      for {
...
object JsonItem_fund_rating_jaResponse extends Json_fund_rating_jaResponse
