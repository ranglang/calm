...
import com.onectrm.akshare.api.generated.fund_public.fund_scale_close_sinaResponse
...
/** 分类1: fund_public 接口: fund_scale_close_sina 目标地址:
  * http://vip.stock.finance.sina.com.cn/fund_center/index.html#jjhqetf 描述: 基金数据中心-基金规模-封闭式基金 限量:
  * 单次返回所有封闭式基金的基金规模数据
  */
case class Respfund_scale_close_sinaResponse(
  `p_xu4hao4`: Integer,
...
case class fund_scale_close_sinaResponse(
  `p_xu4hao4`: Integer,
  `p_ji1jin1dai4ma3`: String,
  `p_ji1jin1jian3cheng1`: String,
  `p_dan1wei4jing4zhi2`: Double,
...
trait Json_fund_scale_close_sinaResponse {

  implicit val a_fund_scale_close_sinaResponse = new Decoder[fund_scale_close_sinaResponse] {
    final def apply(c: HCursor): Decoder.Result[fund_scale_close_sinaResponse] =
      for {
...
object JsonItem_fund_scale_close_sinaResponse extends Json_fund_scale_close_sinaResponse
