...
import com.onectrm.akshare.api.generated.fund_public.fund_em_lcx_rankResponse
...
/** 分类1: fund_public 接口: fund_em_lcx_rank 目标地址:
  * http://fund.eastmoney.com/data/lcxfundranking.html#t;c0;r;sSYL_Z;ddesc;pn50;f;os1; 描述:
  * 东方财富网-数据中心-理财基金排行, 每个交易日17点后更新, 货币基金的单位净值均为 1.0000 元，最新一年期定存利率: 1.50% 限量: 由于目标网站没有数据，该接口暂时未能返回数据
  */
case class Respfund_em_lcx_rankResponse(
  `p_xu4hao4`: Integer,
...
case class fund_em_lcx_rankResponse(
  `p_xu4hao4`: Integer,
  `p_ji1jin1dai4ma3`: String,
  `p_ji1jin1jian3cheng1`: String,
  `p_ri4qi1`: String,
...
trait Json_fund_em_lcx_rankResponse {

  implicit val a_fund_em_lcx_rankResponse = new Decoder[fund_em_lcx_rankResponse] {
    final def apply(c: HCursor): Decoder.Result[fund_em_lcx_rankResponse] =
      for {
...
object JsonItem_fund_em_lcx_rankResponse extends Json_fund_em_lcx_rankResponse
