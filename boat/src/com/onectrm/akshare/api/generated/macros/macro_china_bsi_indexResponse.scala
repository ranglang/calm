...
import com.onectrm.akshare.api.generated.macros.macro_china_bsi_indexResponse
...
/** 分类1: macro 接口: macro_china_bsi_index 目标地址:
  * https://data.eastmoney.com/cjsj/hyzs_list_EMI00107667.html 描述: 超灵便型船运价指数数据, 数据区间从 20060103-至今
  * 限量: 单次返回所有历史数据
  */
case class Respmacro_china_bsi_indexResponse(
  `p_ri4qi1`: String,
...
case class macro_china_bsi_indexResponse(
  `p_ri4qi1`: String,
  `p_zui4xin1zhi2`: Integer,
  `p_zhang3die1fu2`: Double,
  `p_jin43yue4zhang3die1fu2`: Double,
...
trait Json_macro_china_bsi_indexResponse {

  implicit val a_macro_china_bsi_indexResponse = new Decoder[macro_china_bsi_indexResponse] {
    final def apply(c: HCursor): Decoder.Result[macro_china_bsi_indexResponse] =
      for {
...
object JsonItem_macro_china_bsi_indexResponse extends Json_macro_china_bsi_indexResponse
