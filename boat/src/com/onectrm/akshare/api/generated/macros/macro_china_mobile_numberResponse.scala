...
import com.onectrm.akshare.api.generated.macros.macro_china_mobile_numberResponse
...
/** 分类1: macro 接口: macro_china_mobile_number 目标地址:
  * https://data.eastmoney.com/cjsj/hyzs_list_EMI00225823.html 描述: 手机出货量, 数据区间从 201201-至今 限量:
  * 单次返回所有历史数据
  */
case class Respmacro_china_mobile_numberResponse(
  `p_ri4qi1`: String,
...
case class macro_china_mobile_numberResponse(
  `p_ri4qi1`: String,
  `p_zui4xin1zhi2`: Integer,
  `p_zhang3die1fu2`: Double,
  `p_jin43yue4zhang3die1fu2`: Double,
...
trait Json_macro_china_mobile_numberResponse {

  implicit val a_macro_china_mobile_numberResponse =
    new Decoder[macro_china_mobile_numberResponse] {
      final def apply(c: HCursor): Decoder.Result[macro_china_mobile_numberResponse] =
        for {
          ...
          macro_china_mobile_numberResponse(
            p_ri4qi1,
            p_zui4xin1zhi2,
            p_zhang3die1fu2,
...
object JsonItem_macro_china_mobile_numberResponse extends Json_macro_china_mobile_numberResponse
