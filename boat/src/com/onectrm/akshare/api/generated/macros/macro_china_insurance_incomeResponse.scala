...
import com.onectrm.akshare.api.generated.macros.macro_china_insurance_incomeResponse
...
/** 分类1: macro 接口: macro_china_insurance_income 目标地址:
  * https://data.eastmoney.com/cjsj/hyzs_list_EMM00088870.html 描述: 原保险保费收入, 数据区间从 200407-至今 限量:
  * 单次返回所有历史数据
  */
case class Respmacro_china_insurance_incomeResponse(
  `p_ri4qi1`: String,
...
case class macro_china_insurance_incomeResponse(
  `p_ri4qi1`: String,
  `p_zui4xin1zhi2`: Integer,
  `p_zhang3die1fu2`: Double,
  `p_jin43yue4zhang3die1fu2`: Double,
...
trait Json_macro_china_insurance_incomeResponse {

  implicit val a_macro_china_insurance_incomeResponse =
    new Decoder[macro_china_insurance_incomeResponse] {
      final def apply(c: HCursor): Decoder.Result[macro_china_insurance_incomeResponse] =
        for {
          ...
          macro_china_insurance_incomeResponse(
            p_ri4qi1,
            p_zui4xin1zhi2,
            p_zhang3die1fu2,
...
object JsonItem_macro_china_insurance_incomeResponse
    extends Json_macro_china_insurance_incomeResponse
